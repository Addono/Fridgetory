define('./workbox-4d0bff02.js', ['exports'], function (t) {
  ...
  class c {
    ...
    handleRequest({ request: t, event: e }) {
      ...
      if ((!a && this.s && (a = this.s), a)) {
        ...
        return (
          r instanceof Promise && this.i && (r = r.catch((n) => this.i.handle({ url: s, request: t, event: e }))), r
        )
      }
    }
  ...
  const R = (t, e) => t.filter((t) => e in t),
    ...
    x = async ({ cacheName: t, request: e, response: n, event: i, plugins: r = [], matchOptions: c }) => {
      ...
      for (const e of l)
        await e.cacheDidUpdate.call(e, { cacheName: t, event: i, oldResponse: f, newResponse: h, request: o })
    },
    N = L,
    b = async ({ request: t, fetchOptions: e, event: n, plugins: i = [] }) => {
      ...
      try {
        ...
        for (const t of i)
          'fetchDidSucceed' in t && (s = await t.fetchDidSucceed.call(t, { event: n, request: c, response: s }))
        return s
      } catch (t) {
        for (const e of r)
          await e.fetchDidFail.call(e, { error: t, event: n, originalRequest: a.clone(), request: c.clone() })
        throw t
      }
    }
  try {
  ...
  ;(t.CacheFirst = class {
    ...
    (t.precacheAndRoute = function (t, e) {
      !(function (t) {
        D().addToCacheList(t),
          t.length > 0 && (self.addEventListener('install', I), self.addEventListener('activate', W))
      })(t),
        A(e)
    }),
